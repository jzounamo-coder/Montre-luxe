                ...
                {isProfileOpen && isAuthenticated && (
                  ...
                  >
                    ...
                    <div className="py-2">
                      ...
                      <button className="w-full flex items-center gap-3 px-6 py-3 text-[10px] uppercase tracking-widest hover:bg-zinc-50 dark:hover:bg-white/5 transition-colors">
