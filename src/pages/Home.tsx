          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-6 text-zinc-600 dark:text-zinc-400 leading-relaxed text-sm uppercase tracking-wider">
                ...
                <p>Fondée en 2023, Élégance Montre est née d'une ambition simple : faire de chaque seconde un moment de distinction.</p>

<p>Une Vision, Une Signature</p>

<p>Depuis nos débuts, nous croyons qu'une montre dépasse sa fonction première. Elle est le témoin de vos succès, le reflet de votre style et le symbole de votre rigueur. En trois ans, nous avons bâti une collection exigeante où la précision technique rencontre l'esthétique du luxe.</p>

<p>L'Engagement Prestige</p>

<p>Curateurs d'Excellence : Chaque pièce est rigoureusement sélectionnée pour sa fiabilité et son caractère unique.</p>

<p>Expérience Digitale : En 2026, nous redéfinissons l'achat horloger avec une plateforme fluide, sécurisée et exclusivement pensée pour notre clientèle.</p>

<p>Élégance Montre : Portez plus qu'une heure, affirmez votre histoire.</p>
              </div>
            </motion.div>
          </div>
        </div>
